    ...
    <div style=" margin-top: 200vh;">
        ...
        <table class="nodoc">
            <tr>
                ...
                <th style="text-align: center; width:300px;">สถานที่</th>
                <th style="text-align: center; width:300px">รายละเอียดงาน</th>
            </tr>
            ...
            <tr>
                ...
                <td style="padding:3px 5px 3px 3px; text-align: left;">{{ $item->place }} <br>
                    ตำบล{{ $item->subdist_name }}
                    อำเภอ{{ $item->dist_name }}
                    จังหวัด{{ $item->prov_name }}
                </td>
                <td style="padding:3px 5px 3px 3px; text-align: left;">{{ $item->detail }}</td>
            </tr>
            @endforeach
        </table>
    </div>
