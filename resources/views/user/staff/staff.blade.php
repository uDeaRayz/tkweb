...
<div class="d-flex flex-row-reverse add-btn">
    <a href="{{ url('/staff/create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> {{ __('เพิ่มพนักงาน') }}</a>
</div>
        ...
        <tbody>
            <tr>
                ...
                <td class="text-center">
                    <a href="{{ route('show') }}" class="btn btn-info" data-toggle="view" title="ดูข้อมูล"><i class="fas fa-eye"></i></a>
                    <a href="{{ route('edit') }}" class="btn btn-warning" data-toggle="edit" title="แก้ไขข้อมูล"><i class="fas fa-pencil-alt"></i></a>
