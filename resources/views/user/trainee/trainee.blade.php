...
<div class="d-flex flex-row-reverse add-btn">
    <a href="{{ route('trainee.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i>
        {{ __('เพิ่มนักศึกษาฝึกงาน') }}</a>
</div>
@if (count($trainee) === 0)
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="{{ route('trainee.show',$item->id) }}" class="btn btn-info" data-toggle="view"
                        title="ดูข้อมูล"><i class="fas fa-eye"></i></a>
                    <a href="{{ route('trainee.edit',$item->id) }}" class="btn btn-warning" data-toggle="edit"
